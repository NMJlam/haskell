...
module Parser (char, int, is, matches, string, parseGET, whitespace, parseURL, parseHTTPRequest) where
...
-- a URL and the HTTP version string.
-- >>> parseHTTPRequest "GET /index.html"
-- Just ("",("GET","/index.html"))
--
-- >>> parseHTTPRequest "GET /hello/world"
-- Just ("",("GET","/hello/world"))
--
